...
batch_size=200
## Parameter for running experiments > 1  or the normal mode = 1.0, Nystroem < 1
computation=1.0

#CUDA_VISIBLE_DEVICES=1 python -m plotting.createStartPlot # for create startPlot #
#python -m plotting.compareMethodsPlot compareMethodsOverError
#python -m plotting.createSymmetricMatrix "./plotting/original/00.h5" "./plotting/original/symm.h5"

#python -m plotting.testParallelizedKernelComputation
...
#python -m plotting.testParallelizedKernelComputation startTest
#
#python -m plotting.testParallelizedKernelComputation testEquality
