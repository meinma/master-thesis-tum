...
def compareAccuracyOverTime(repetitions=3):
    ...
    mean_errors = svd_mean_error[0], nyst_mean_error[0]
    createPlots(mean_errors, FRACTIONS,
                title='Expected relative error of approximated and exactly computed 12 500 * 12 500 kernel matrix'
                , name='rmse_125', ylabel='Relative RMSE',
    ...
    mean_times = svd_mean_time[0], nyst_mean_time[0]
    createPlots(mean_times, FRACTIONS,
                title='Expected computation time for approximating 12 500 * 12 500 kernel matrix exactly computed values',
                name='timing_125', ylabel='Time in minutes',
                xlabel='Fraction of exactly computed values of the kernel matrix ')
    # Plot accuracy over fraction for different types
    mean_accuracies = svd_mean_accuracy[0], nyst_mean_accuracy[0]
    ...
    createPlots(mean_accuracies, FRACTIONS,
                title='Expected prediction accuracy over the fraction of exactly computed values of 12 500 * 12 500 matrix',
                name='accuracy_125', ylabel='Accuracy', xlabel='Fraction of exactly computed values of the '
                                                               'kernel '
                                                               'matrix')
